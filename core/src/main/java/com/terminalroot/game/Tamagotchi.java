...
public class Tamagotchi {
    ...
    public String mastigar(Inimigo comida) {
        if (!estaVivo) return "";
        ...
        if (this.pv < 100) this.pv += 10;

        this.felicidade -= 5;
        

        String mensagem = String.format("%s usou %s e causou %.1f de dano no %s!", nome, talherEquipado, danoCalculado, comida.getTipo());
    ...
    String mensagem = nome + " dormiu e recuperou suas energias!";
    System.out.println(mensagem);
    ...
    public String defender() {
        ...
        String mensagem = nome + " brincou e se divertiu!";
        System.out.println(mensagem);
